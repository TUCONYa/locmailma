...
try:
 n_valid = 0
 fileEmail = open(input("•Nhập File Chứa List Mail(ex: mail.txt) : ")).readlines()
...
'accept-language':'vi-VN,vi;q=0.9,en-US;q=0.8,en;q=0.7'}
 ...
 if 'mật khẩu' in a2:
    print("\033[1;32m[True]" " \033[1;33mHits : " + email_fb + "\033[1;32m")
    open(valid,"a").write(email_fb)
 else:
    print("\033[1;31m[False]" " \033[1;33mCustom : " + email_fb + "\033[1;31m")
